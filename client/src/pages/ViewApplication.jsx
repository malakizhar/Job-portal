        ...
        <table className="w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm">
          <thead>
            <tr className="border-b">
              <th className="py2 px-4 text-left">#</th>
              <th className="py2 px-4 text-left">User name</th>
              <th className="py2 px-4 text-left max-sm:hidden">Job Title</th>
              <th className="py2 px-4 text-left max-sm:hidden">Location</th>
              <th className="py2 px-4 text-left">Resume</th>
              <th className="py2 px-4 text-left">Action</th>
            </tr>
          </thead>
          <tbody>
